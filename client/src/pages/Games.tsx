...
const ITEMS: Item[] = [
  // Supermarket
  { name: 'Anchor Blue Cap Milk 2L (Countdown)',                     category: 'Supermarket', price: 4.65,  emoji: '🥛' },
  { name: 'Mainland Mild Cheddar Block 500g (New World)',            category: 'Supermarket', price: 11.99, emoji: '🧀' },
  { name: "Vogel's Original Mixed Grain Bread 700g (Pak'nSave)",     category: 'Supermarket', price: 6.29,  emoji: '🍞' },
  { name: "Wattie's Baked Beans in Tomato Sauce 420g (Countdown)",   category: 'Supermarket', price: 2.39,  emoji: '🫘' },
  { name: 'Sanitarium Weet-Bix 750g (Countdown)',                    category: 'Supermarket', price: 7.49,  emoji: '🥣' },
  { name: 'Pams Free Range Eggs 12pk (Countdown)',                   category: 'Supermarket', price: 9.99,  emoji: '🥚' },
  { name: 'Tasti Peanut Butter Smooth 380g (New World)',             category: 'Supermarket', price: 5.49,  emoji: '🥜' },
  { name: 'Marmite Original Spread 400g (New World)',                category: 'Supermarket', price: 7.99,  emoji: '🫙' },
  { name: "Sunrice Medium Grain White Rice 5kg (Pak'nSave)",         category: 'Supermarket', price: 13.99, emoji: '🍚' },
  { name: 'Macro Organic Chicken Breast 500g (Countdown)',           category: 'Supermarket', price: 14.99, emoji: '🍗' },
  { name: 'Lewis Road Creamery Chocolate Milk 1L (New World)',       category: 'Supermarket', price: 6.99,  emoji: '🍫' },
  { name: "Whittaker's Dark Ghana Chocolate 250g (Countdown)",       category: 'Supermarket', price: 6.99,  emoji: '🍫' },
  { name: 'Tip Top Boysenberry Ripple Ice Cream 2L (Countdown)',     category: 'Supermarket', price: 9.99,  emoji: '🍦' },
  { name: "Barker's Boysenberry Jam 370g (Countdown)",               category: 'Supermarket', price: 6.49,  emoji: '🫙' },
  { name: 'Proper Crisps Marlborough Sea Salt 140g (New World)',     category: 'Supermarket', price: 6.99,  emoji: '🧂' },
  { name: "Tegel Chicken Drumsticks 1kg (Pak'nSave)",                category: 'Supermarket', price: 10.99, emoji: '🍗' },
  { name: "Gregg's Espresso Ground Coffee 200g (Countdown)",         category: 'Supermarket', price: 10.99, emoji: '☕' },
  { name: 'Healtheries Peppermint Tea 40 bags (New World)',          category: 'Supermarket', price: 5.49,  emoji: '🍵' },
  { name: 'Homebrand White Sandwich Bread 700g (Countdown)',         category: 'Supermarket', price: 2.29,  emoji: '🍞' },
  { name: "Countdown Salmon Portions 300g (Pak'nSave)",              category: 'Supermarket', price: 13.99, emoji: '🐟' },
  { name: "Nescafé Gold Blend Instant Coffee 100g (Countdown)",      category: 'Supermarket', price: 10.49, emoji: '☕' },
  { name: 'Primo Kransky Sausages 4pk (New World)',                  category: 'Supermarket', price: 8.99,  emoji: '🌭' },
  { name: "Pam's Frozen Garden Peas 1kg (Countdown)",                category: 'Supermarket', price: 4.49,  emoji: '🫛' },
  { name: "Charlie's Apple & Feijoa Juice 1L (New World)",           category: 'Supermarket', price: 5.99,  emoji: '🍎' },
  // Fast food
  { name: "McDonald's Big Mac (NZ)",                                 category: 'Fast Food',   price: 11.70, emoji: '🍔' },
  { name: 'KFC 3pc Box Meal (NZ)',                                   category: 'Fast Food',   price: 19.99, emoji: '🍗' },
  { name: "Domino's Traditional Value Pizza Large (pickup)",         category: 'Fast Food',   price: 11.99, emoji: '🍕' },
  { name: 'Subway 6-inch Italian BMT',                               category: 'Fast Food',   price: 12.50, emoji: '🥖' },
  { name: 'Burger King Whopper Meal (NZ)',                           category: 'Fast Food',   price: 17.90, emoji: '🍔' },
  { name: "Hell's Pizza Classic Meltdown 11-inch (pickup)",          category: 'Fast Food',   price: 22.00, emoji: '🍕' },
  { name: "Wendy's Dave's Single Burger (NZ)",                       category: 'Fast Food',   price: 13.50, emoji: '🍔' },
  { name: "Carl's Jr. Double Famous Star (NZ)",                      category: 'Fast Food',   price: 16.50, emoji: '🍔' },
  { name: "Taco Bell Crunchy Taco Supreme (NZ)",                     category: 'Fast Food',   price: 7.50,  emoji: '🌮' },
  // Café
  { name: 'Flat White (standard NZ café)',                           category: 'Café',        price: 6.50,  emoji: '☕' },
  { name: 'Gong Cha Milk Tea Large (NZ)',                            category: 'Café',        price: 9.50,  emoji: '🧋' },
  { name: 'Muffin Break Large Blueberry Muffin',                     category: 'Café',        price: 6.00,  emoji: '🧁' },
  { name: 'Starbucks Caramel Macchiato Tall (NZ)',                   category: 'Café',        price: 8.50,  emoji: '☕' },
  // Clothing
  ...
  { name: "Glassons Women's Linen Shorts Size S",                    category: 'Clothing',    price: 44.99, emoji: '🩳' },
  { name: "Farmers Men's Merino Blend Socks 3pk",                    category: 'Clothing',    price: 14.99, emoji: '🧦' },
  ...
  // Pharmacy / Health
  { name: 'Panadol Rapid 20 Caplets (Countdown)',                    category: 'Pharmacy',    price: 9.49,  emoji: '💊' },
  { name: 'Dettol Antibacterial Hand Wash 250ml (Countdown)',        category: 'Pharmacy',    price: 5.49,  emoji: '🧴' },
  { name: 'Oral-B Classic Manual Toothbrush 2pk',                    category: 'Pharmacy',    price: 7.99,  emoji: '🪥' },
  { name: 'Band-Aid Flexible Fabric 25pk',                           category: 'Pharmacy',    price: 6.49,  emoji: '🩹' },
  { name: 'Biofreeze Pain Relief Gel 118ml (Chemist Warehouse)',     category: 'Pharmacy',    price: 22.99, emoji: '🧴' },
  { name: 'Colgate Total Advanced Toothpaste 170g (Countdown)',      category: 'Pharmacy',    price: 6.49,  emoji: '🪥' },
  // Household
  { name: 'Palmolive Antibacterial Dish Liquid 500ml (Countdown)',   category: 'Household',   price: 4.49,  emoji: '🫧' },
  { name: "Quilton 3-ply Toilet Paper 18pk (Pak'nSave)",             category: 'Household',   price: 16.99, emoji: '🧻' },
  { name: 'Fairy Dishwashing Liquid 750ml (New World)',              category: 'Household',   price: 7.49,  emoji: '🫧' },
  { name: 'Jif Cream Cleanser 500ml (Countdown)',                    category: 'Household',   price: 4.99,  emoji: '🧹' },
  { name: 'Huggies Gold Nappies Size 4 40pk (Countdown)',            category: 'Household',   price: 29.99, emoji: '👶' },
  { name: "Finish Quantum Dishwasher Tablets 60pk (Pak'nSave)",      category: 'Household',   price: 24.99, emoji: '✨' },
  { name: "Glad Press'n Seal Wrap 30m (Countdown)",                  category: 'Household',   price: 7.49,  emoji: '📦' },
  // Drinks / Snacks
  { name: "Monster Energy Ultra White 500ml (Pak'nSave)",            category: 'Drinks',      price: 4.29,  emoji: '⚡' },
  { name: 'Coca-Cola Original 1.5L (Countdown)',                     category: 'Drinks',      price: 4.99,  emoji: '🥤' },
  { name: 'Up&Go Energize Vanilla 3pk (Countdown)',                  category: 'Drinks',      price: 7.99,  emoji: '🥤' },
  { name: "Schweppes Lemon Sparkling Water 1.5L (Pak'nSave)",        category: 'Drinks',      price: 3.49,  emoji: '💧' },
  { name: 'Bundaberg Ginger Beer 375ml 4pk (New World)',             category: 'Drinks',      price: 11.99, emoji: '🍺' },
  { name: 'V Energy Drink 250ml 4pk (Countdown)',                    category: 'Drinks',      price: 9.99,  emoji: '⚡' },
  // Electronics / Stationery
  { name: 'Energizer Max AA Batteries 8pk (The Warehouse)',          category: 'Electronics', price: 14.99, emoji: '🔋' },
  { name: 'Duracell Plus AA Batteries 4pk (Countdown)',              category: 'Electronics', price: 9.99,  emoji: '🔋' },
  { name: 'Verbatim USB-C to USB-A Cable 1m (The Warehouse)',        category: 'Electronics', price: 16.99, emoji: '🔌' },
  { name: 'Reflex A4 Copy Paper 500 sheets (OfficeMax)',             category: 'Stationery',  price: 14.99, emoji: '📄' },
  { name: 'Bic Cristal Ballpoint Pens 10pk Blue (The Warehouse)',    category: 'Stationery',  price: 6.99,  emoji: '✏️' },
];
