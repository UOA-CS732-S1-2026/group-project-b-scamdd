...
export default function Auth() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      // Navigate directly — don't rely on useSession() reactively updating after logout+login
  ...
  return (
    <div className="min-h-screen sm:h-screen sm:overflow-hidden bg-[var(--c-bg)] flex flex-col">
              ...
              {mode === 'forgot-sent' ? (
                <div className="flex flex-col gap-4 mt-4">
                  <p className="text-sm text-[var(--c-text-2)]">
                    ...
                    <span className="text-[var(--c-text)] font-medium">{email}</span>, a reset link
                    has been sent.
                  </p>
          ...
          {mode === 'auth' && (
            <>
              ...
              <p className="text-sm text-[var(--c-text-2)] mb-4">
                {tab === 'signin'
                  ? 'Sign in to your felt account.'
                  : 'Start tracking your money with felt.'}
              </p>
                ...
                <div className="flex flex-col gap-1">
                  <div className="flex justify-between items-baseline">
                    ...
                    {tab === 'signin' && (
                      <button
                        type="button"
                        className="text-xs text-[var(--c-accent)] hover:opacity-75 transition-opacity"
                        onClick={() => {
                          setMode('forgot');
                          setError('');
                        }}
